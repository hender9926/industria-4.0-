...
<div class="modal" id="addUsu" tabindex="-1" role="dialog" aria-hidden="true">
      ...
      <div class="modal-body">
          ...
          <div class="form-group row">
            <div class="col-md-6 col-sm-6 form-group has-feedback">
              <input type="text" class="form-control has-feedback-left" name="usu_name" minlength="4" maxlength="30" placeholder="Nombre">
          ...
          <div class="form-group row">
            <div class="col-md-6 col-sm-6 form-group has-feedback">
              <input type="mail" class="form-control has-feedback-left" name="email"  minlength="4" maxlength="30" placeholder="E-mail">
